...
class DataModelExcel:
    def __init__(self, output_file="data_model.xlsx"):
    ...
    def create_data_model(self):
        tables_df = pd.DataFrame(self.tables_data)
        columns_df = pd.DataFrame(self.columns_data)
        relationships_df = pd.DataFrame(self.relationships_data)
        ...
        print(f"Data model created successfully: {self.output_file}")
